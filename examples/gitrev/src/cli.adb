...
package body cli is
   ...
   begin
      Put("Repo ") ; Put_Line( revisions.repo ) ;
   end ShowRevision;
   ...
   begin
      ...
      GNAT.Command_Line.Define_Switch
        (Config, Version'Access, Switch => "-r:",
         Long_Switch                       => "--revision:",
   ...
   begin
      ...
      Put (Verbose);
      New_Line;
      Put("Output File "); Put_Line(outputFile.all);
      Put("Version "); Put_Line(version.all);
